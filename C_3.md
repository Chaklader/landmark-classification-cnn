...
ensure that the dimensions are compatible throughout the network. When we want to implement using the PyTorch, the following needs to be considered:
...
##### Question 4 of 4: Consider the following layer:
...
Of course with the *nn.Sequential* equivalent:
