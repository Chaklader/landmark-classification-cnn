...
<p align="center"><em>figure: Visualization of color filters and their application in CNNs</em></p>
...
<br>
<p align="center">
<img src="images/convolution_process.gif" alt="Convolution Process" width="600" height=auto>
</p>
<p align="center"><em>figure: Animation showing the convolution process on a color image with multiple channels</em></p>
...
### Q#1: Let's consider an input image of size 6x6, and a kernel 3x3. What would be the output size if we use no
...
### Q#1: Let's consider a convolutional layer with in_channels=3, out_channels=16, kernel_size=5 and padding=2. How many
...
<p align="center"><em>figure: A detailed structure of a typical CNN</em></p>
...
<p align="center"><em>figure: Flattening of feature maps into a 1d vector</em></p>

<br>
<p align="center">
<img src="images/detailed_2.png" alt="Feature Vector Formation" width="600" height=auto>
</p>
<p align="center"><em>figure: Formation of the feature vector</em></p>
...
### Q#3: Let's consider an image that is (3, 224, 224), i.e., an RGB image (3 channels) with height and width both equal

to **224**. If we push it through the network, what is the shape of the output?
...
### Q#4: Consider the same network as in Question 3, but with an additional nn.Flatten() layer at the end. What is the shape
...
### Q#5: What should be the value of feature_vector_dim in the first linear layer? In other words, what is the dimension

of **the** feature vector that is fed to the head? Also, how many classes does this classifier handle?
...
Explanation: The network has two **Conv2d** layers, forming the convolutional part. The MLP part consists of three
Linear
...
<p align="center"><em>figure: A typical training augmentation pipeline</em></p>
...
classes implement augmentation policies that have been optimized in a data-driven way, by performing large-scale
...
<br>
<p align="center">
<img src="images/bn.png" alt="Batch Normalization" width="600" height=auto>
</p>
<p align="center"><em>figure: Batch Normalization</em></p>
...
<p align="center"><em>figure: Hyperparameter Tuning</em></p>
...
<p align="center"><em>figure: Learning Rate Finder</em></p>
...
**Batch Normalization (BatchNorm)**: A layer that normalizes the activations coming from a layer to decouple layers
from
