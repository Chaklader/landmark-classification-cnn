...
Image augmentation artificially expands your training dataset by creating modified versions of existing images. Rather
...
The strength of augmentation should match the natural variability in your target domain. For instance, horizontal flips
are appropriate for natural images but might be detrimental for digit recognition where orientation carries meaning.
...
The hyperparameter tuning process can be formalized as a bi-level optimization problem:

$$\arg\max_H M(\arg\min_W L(W|H))$$
