...
two workhorse architectures for object detection and semantic segmentation, respectively: *RetinaNet* and *UNet.* The core computer vision tasks and their objectives are:
...
The implementation Loss Components is:
...
The implementation of Training Loop is:
