...
| d        | Semantic segmentation | Determine the class of each _pixel_ in the image                                                      |
| e        | Instance segmentation | Determine the class of each _pixel_ in the image distinguishing different instances of the same class |
...
<p align="center"><em>figure: Multi-head architecture for object localization showing backbone and two heads</em></p>
...
<p align="center"><em>figure: Sliding window approach for object detection</em></p>
...
<p align="center"><em>figure: Feature Pyramid Network (FPN) architecture for multi-scale feature extraction</em></p>
...
<p align="center"><em>figure: RetinaNet architecture combining FPN with focal loss for object detection</em></p>
...
<p align="center"><em>figure: Focal Loss function for addressing class imbalance in object detection</em></p>
...
<p align="center"><em>figure: Example of bird detection showing bounding box and IoU calculation</em></p>
...
<p align="center"><em>figure: UNet architecture for semantic segmentation with encoder-decoder structure</em></p>
...
The library also implements the Dice loss. This is how you can define a UNet using this library:
